...
export function loadConfig(overrides?: Partial<AgentConfig>): AgentConfig {
  ...
  const defaults: AgentConfig = {
    ...
    paths: {
      projectRoot,
      promptsDir: `${projectRoot}/.claude/prompts`,
      specsDir: `${projectRoot}/specs`,
      implementationStatus: `${projectRoot}/.claude/IMPLEMENTATION_STATUS.md`,
      convictionLog: `${projectRoot}/.claude/CONVICTION_LOG.md`,
      learnLog: `${projectRoot}/.claude/LEARN_LOG.md`,
