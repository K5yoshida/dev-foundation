...
> 所要時間: 1〜2時間
> 参照: `.claude/01_.claude/01_docs/19_エラーカタログと監視ポリシー.md`, `.claude/01_.claude/01_docs/22_テレメトリとKPI定義一覧.md`
...
`.claude/01_.claude/01_docs/22_テレメトリとKPI定義一覧.md` に基づき、以下が計測できているか確認:
